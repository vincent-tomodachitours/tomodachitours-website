...
const UjiTour = () => {
    ...
    useEffect(() => {
        const loadTourData = async () => {
            try {
                setLoading(true);
                const data = await getTour('uji-tour');
                setTourData(data);
                console.log('✅ Uji tour data loaded:', data);
            } catch (error) {
                console.error('❌ Failed to load uji tour data:', error);
            } finally {
                setLoading(false);
            }
        };
    ...
    return (
        <div id='app-container' className='w-full h-screen min-h-screen flex flex-col overflow-y-auto'>
            <SEO
                ...
                image="/IMG/Uji-Tour/icecream.webp"
            />

            {/* Structured Data */}
            <StructuredData data={tourSchemas.ujiTour} />
            <StructuredData data={{
                ...
                itemListElement: [
                    ...breadcrumbSchemas.tours.itemListElement,
                    {
                        ...
                        "item": "https://tomodachitours.com/tours/matcha-grinding-experience-and-walking-tour-in-uji-kyoto"
                    }
                ]
            }} />
