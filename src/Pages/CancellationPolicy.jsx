...
const CancellationPolicy = () => {
    usePageTracking('Cancellation Policy');

    return (
        <div className='min-h-screen flex flex-col bg-gradient-to-b from-white to-stone-100'>
            <SEO
                title={seoData.cancellationPolicy.title}
                description={seoData.cancellationPolicy.description}
                keywords={seoData.cancellationPolicy.keywords}
            />
            <Header />
