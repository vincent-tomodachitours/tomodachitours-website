                        ...
                        <div className='fixed inset-0 w-full h-full bg-white z-50 grid place-items-center'>
                            ...
                            <div className='w-1/2 h-1/2 m-auto'>
                                <ul className='font-ubuntu text-4xl text-center flex flex-col space-y-10'>
                                    <li onClick={() => setMenuOpen(false)}><Link to="/" className='underline cursor-pointer'>Home</Link></li>
                                    <li onClick={() => setMenuOpen(false)}><Link to="/tours" className='underline cursor-pointer'>Tours</Link></li>
                                    <li onClick={() => setMenuOpen(false)}><Link to="/about" className='underline cursor-pointer'>About</Link></li>
                                    <li onClick={() => setMenuOpen(false)}><Link to="/recommendations" className='underline cursor-pointer'>Guide</Link></li>
                                </ul>
                            </div>
                        </div>
                    )}
