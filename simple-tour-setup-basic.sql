-- Basic Tour Management System Setup for Supabase
-- This script only creates the tours table without admin permissions
...
-- Success message
SELECT 'Tour management system setup complete! 🎉' AS message,
