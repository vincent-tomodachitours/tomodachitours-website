...
class PrivacyManager {
    ...
    showConsentBanner() {
        ...
        document.getElementById('privacy-accept-necessary').addEventListener('click', () => {
            this.acceptNecessaryOnly();
        });
    }
    ...
    exportUserData() {
        const userData = {
            ...
            consentTimestamp: localStorage.getItem(STORAGE_KEYS.CONSENT_TIMESTAMP),
            consentVersion: localStorage.getItem(STORAGE_KEYS.CONSENT_VERSION),
