...
import { storeUserInteraction } from './helpers.js';
import { getCartData, getTimeInCart, storeAbandonmentData, getCheckoutStep } from './cartTracking.js';
...
export const trackCheckoutAbandonment = (checkoutStage, tourData) => {
...
export const trackFunnelStep = (stepName, tourData, stepNumber = null) => {
    if (!getShouldTrack() || !tourData) return;
