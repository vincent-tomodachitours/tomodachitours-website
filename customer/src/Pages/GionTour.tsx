...
const GionTour: React.FC = () => {
    ...
    const itineraryStops = [
        { title: "Gion Shirakawa", duration: "15 minutes", description: "Historic geisha district with traditional architecture" },
        { title: "Hanamikoji Street", duration: "20 minutes", description: "Famous street in Gion district" },
        { title: "Yasaka Shrine", duration: "20 minutes", description: "Beautiful Shinto shrine" },
        { title: "Sannenzaka & Ninenzaka", duration: "30 minutes", description: "Historic stone-paved streets" },
        { title: "Kiyomizu-dera Temple", duration: "60 minutes", description: "UNESCO World Heritage wooden temple" }
    ];
