...
const UjiWalkingTour = () => {
    ...
    const itineraryStops = [
        ...
        { name: "Byodo-in Temple", duration: "60 minutes" },
        { name: "Uji River & Historic Bridges", duration: "20 minutes" },
        { name: "Uji Shrine", duration: "25 minutes" },
        { name: "Tea Street Walking", duration: "30 minutes" }
    ];
