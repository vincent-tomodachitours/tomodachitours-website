...
const UjiWalkingTour = () => {
    ...
    useEffect(() => {
        ...
        const loadTourData = async () => {
            try {
                setLoading(true);
                const data = await getTour('uji-walking-tour');
                setTourData(data);
                console.log('✅ Uji walking tour data loaded:', data);
                ...
                console.error('❌ Failed to load uji walking tour data:', error);
            } finally {
                setLoading(false);
            }
        };
                                ...
                                {activeContent === 1 &&
                                    <div className='font-ubuntu flex flex-col gap-6 mt-8'>
                                        <div className="px-4 space-y-6">
                                            <p>Explore the historic town of Uji, the birthplace of Japanese tea culture, on this immersive walking tour. Visit the famous Byodo-in temple, known for its appearance on the 10-yen coin, and discover the rich history and traditions of Japan's tea capital.</p>
                                            ...
                                            <p>✅ Explore Historic Shrines – Visit Uji Shrine and Ujigami Shrine, both steeped in centuries of history.</p>

                                            <p>✅ Scenic Walking Routes – Enjoy beautiful views along the Uji River and historic bridges.</p>
                                        </div>
                ...
                <div className="mt-16 mb-12">
                    <div className="text-center mb-8">
                        ...
                        <p className="text-gray-600 max-w-2xl mx-auto">
                            See what our guests say about their Uji walking tour and temple experience
                        </p>
                    </div>
                    <TripAdvisorReviews
