...
const MusicTour: React.FC = () => {
    ...
    const itineraryStops = [
        { title: "Tofukuji Walking Tour", duration: "2 hours", description: "Explore the historic Tofukuji Temple grounds and surrounding areas" },
        { title: "Authentic Tea Ceremony", duration: "1 hour", description: "Participate in a traditional Japanese tea ceremony experience" },
        { title: "Traditional Music Performance", duration: "1 hour", description: "Experience authentic Japanese musical traditions with live performances" }
    ];
