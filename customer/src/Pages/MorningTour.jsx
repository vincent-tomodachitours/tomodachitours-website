...
const MorningTour = () => {
    ...
    const itineraryStops = [
        { name: "Fushimi Inari Taisha Shrine", duration: "90 minutes", description: "Famous for thousands of vermillion torii gates" },
        { name: "Arashiyama Bamboo Grove", duration: "45 minutes", description: "Walk through the enchanting bamboo forest" },
        { name: "Tenryu-ji Temple", duration: "60 minutes", description: "UNESCO World Heritage Zen temple with beautiful gardens" }
    ];
