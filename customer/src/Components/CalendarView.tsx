...
interface CalendarViewProps {
    ...
    handleAdultParticipantsChange: (value: number) => void;
    handleChildParticipantsChange: (value: number) => void;
    handleInfantParticipantsChange: (value: number) => void;
    availabilityLoading: boolean;
    loadingAvailability: boolean;
    disableDates: ({ date, view }: { date: Date; view: string }) => boolean;
    onCalendarChange: (value: any) => void;
    calendarSelectedDate: Date;
    calendarActiveStartDate: Date;
    setCalendarActiveStartDate: (args: any) => void;
    oneYearsLater: Date;
    minViewLimit: Date;
    tourId: string;
}
        ...
        <div>
            ...
            <div className="relative">
                ...
                <Calendar
                    ...
                    showNavigation={true}
                    navigationLabel={({ date }: { date: Date }) => date.toLocaleDateString('en-US', { month: 'long', year: 'numeric' })}
                />
            </div>
        </div>
    );
