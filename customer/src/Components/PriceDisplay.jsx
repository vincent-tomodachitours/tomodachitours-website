...
/**
 * PriceDisplay component that shows JPY price with USD conversion and optional Viator comparison
 * @param {Object} props
 * @param {number} props.jpyPrice - Current price in JPY (discounted price)
 * @param {number} props.originalPrice - Original Viator price in JPY (optional)
 * @param {string} props.className - Additional CSS classes
 * @param {boolean} props.showPerGuest - Whether to show "/ Guest" text
 * @param {boolean} props.showViatorComparison - Whether to show Viator price comparison
...
const PriceDisplay = ({
    ...
    const { usdAmount, loading } = useCurrency(jpyPrice);
