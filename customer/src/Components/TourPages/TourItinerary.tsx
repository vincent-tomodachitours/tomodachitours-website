...
import { TourItineraryComponentProps } from '../../types';

const TourItinerary: React.FC<TourItineraryComponentProps> = ({ stops, meetingPoint, isExpanded, setIsExpanded, isMobile }) => {
    const getStopIcon = (index: number) => {
    ...
    // const allStops = [ // Unused variable removed
