...
import { BaseTourPageProps, TourData } from '../../types';
...
const BaseTourPage: React.FC<BaseTourPageProps> = ({
    ...
    const { usdAmount } = useCurrency(tourPrice) as { usdAmount: string; loading: boolean; error: string | null };
    ...
    const [isContentExpanded, setIsContentExpanded] = useState<boolean>(!isMobile); // Expanded by default on desktop
    ...
    const scrollToBooking = () => {
        ...
        if (tourData) {
            try {
                ...
                console.log('Begin checkout tracked for mobile Book Now button:', tourData['tour-title']);
            } catch (error) {
                        ...
                        <div className='flex flex-col-reverse md:flex-row'>
                            <div className='w-full'>
                                <TourTabs
                                    ...
                                    tourId={tourId}
                                    tourTitle={tourTitle}
                                    trackTourTabClick={trackTourTabClickExtended}
                                />
