import type { TourSchema, BreadcrumbSchema, FAQSchema } from '../types/data';
...
export const tourSchemas: Record<string, TourSchema> = {
    nightTour: {
        "@context": "https://schema.org",
...
export const breadcrumbSchemas: Record<string, BreadcrumbSchema> = {
    home: {
        "@context": "https://schema.org",
        "@type": "BreadcrumbList",
        "itemListElement": [
...
export const faqSchemas: Record<string, FAQSchema> = {
    general: {
        "@context": "https://schema.org",
        "@type": "FAQPage",
        "mainEntity": [
