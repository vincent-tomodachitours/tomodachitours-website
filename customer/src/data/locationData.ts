import type { KyotoDistricts, TourismKeywords, BusinessInfo } from '../types/data';

// Location-based content for Kyoto districts and attractions
export const kyotoDistricts: KyotoDistricts = {
    gion: {
        name: "Gion District",
...
export const tourismKeywords: TourismKeywords = {
    primary: [
        "Kyoto tours",
        "English tours Kyoto",
        "Kyoto walking tours",
